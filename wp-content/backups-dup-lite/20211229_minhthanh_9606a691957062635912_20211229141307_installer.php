...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211229_minhthanh_9606a691957062635912_20211229141307_archive.zip';
	const ARCHIVE_SIZE		 = '65490296';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9606a69-29141307';
    const SECONDARY_PACKAGE_HASH = '69916c4-29141307';
	const VERSION			 = '1.4.3';
