...
if ( ! class_exists( 'Retailer_Customizer' ) ) :
	...
	public function default_theme_mod_values() {
      ...
      /**
		 ...
		 * Cat
		 */
		 $wp_customize->add_setting( 'retailer_number_cat', array (
      		'sanitize_callback' => 'sanitize_text_field',
	    ) );
	    
	    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'retailer_number_cat', array(
	      'label'    => __( 'Categories show at most ', 'retailer' ),
	      'section'  => 'static_front_page',
	      'settings' => 'retailer_number_cat',
	      'priority'    => 101,
	    ) ) );
