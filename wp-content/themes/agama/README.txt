Agama WordPress Theme, Copyright 2015 - 2021 theme-vision.com
Agama is distributed under the terms of the GNU GPL2

####################### Changelog ######################

= 1.6.8 - 1 December 2021 =
* Added option to switch the primary menu to right side on the header section.
* Fixed top navigation menu not showed on mobile devices.
* Fixed minor bugs/issues for WordPress 5.8.2 compatibility.

= 1.6.7 - 10 August 2021 =
* Updated Kirki framework to the latest version.

= 1.6.6 - 11 May 2021 =
* Added option for tagline Font size, weight, family.
* Added option for pages title enable/disable feature.
* Fixed tagline width in header version 1 and version 3.
* Fixed reduce space between site title and tagline.
* Fixed sidebar title and content font size by +2px.
* Fixed particles are not worked on sliders.
* Fixed blogs icon changed.
* Fixed minor bugs/issues.
* Updated Kirki framework to the latest version.

= 1.6.5 - 16 April 2021 =
* Added option to display title and tagline individually.
* Added option to customize tagline colors.
* Added instagram social share icon.
* Fixed search icon is now hidden in mobile portrait view.
* Fixed mobile menu not showing in mobile devices.
* Fixed minor bugs/issues.
...
= 1.5.1 - 29 February 2020 =
* Added Feather icons support.
* Redesigned About Agama theme page.
* Updated theme default color.
* Updated theme translation files.
 ...
 * Pexels.com - https://www.pexels.com/photo/silver-imac-near-white-ceramic-kettle-205316/ - CC0 1.0 License
 ...
 Images used in Header are licensed under Creative Commons Zero License:
